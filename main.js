...
function startClassifictaion() {
    ...
    classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/nthNDYBJm/model.json',modelReady);
}
function modelReady() {
...
function gotResult(error, results) {
    if(error){
        ...
        if(results[0].label == "Barking"){
            ...
            img.src = "https://i.pinimg.com/originals/32/14/15/3214157614e454626c5c6e7d58c0e68b.gif";
            cow = cow+1;
